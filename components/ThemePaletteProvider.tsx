...
export type ThemePaletteId = "default" | "kodama" | "starry-night" | "bubblegum" | "doom" | "soft-pop" | "notebook" | "cyberpunk";
...
export function ThemePaletteProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      if (stored === "kodama" || stored === "default" || stored === "starry-night" || stored === "bubblegum" || stored === "doom" || stored === "soft-pop" || stored === "notebook" || stored === "cyberpunk") {
